...
const Funding = lazy(() => import("../AuthHome/FundingAndWithdrawal/Funding"));
function HeadText() {
    ...
    <>
      <div className="w-full h-16 bg-[#171718] overflow-hidden flex lg:pl-10 pl-5">
        ...
        <span className="flex items-center ml-auto mr-5">
          <span className="w-fit h-fit  bg-[#3a3ac5] hover:bg-[#0e0e77]  hover:transition-all p-1 pl-2 pr-2 font-semibold text-gray-100 rounded-md  pointer">
            <h5
