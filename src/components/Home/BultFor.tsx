  ...
  return (
    <div className=" mt-16 h-fit pt-1 pb-4 w-full relative bg-[#f7f3f369] appear-element">
      ...
      <span className="flex flex-col pl-8 mt-4 pr-8">
        <h5 className="text-[2.5rem] font-serif  font-normal">
          Finding the right opportunity is hard. We make it easier.
        </h5>
        <h5 className="text-[1.1rem] font-semibold font-sans mt-2">
          Texas Homes innovative marketplace connects investors with corporate
        ...
        <span className="flex w-full gap-3 flex-wrap justify-around ">
          <span className="flex flex-col bg-[white] w-fit max-w-[35rem] min-h-fit max-h-80 pb-9 pt-9  p-7 rounded-xl  ">
            ...
            <p className="mt-2 text-[1rem] font-sans font-normal">
              Private credit can be a short- or long-term strategy. Potentially
              earn 15%+ intrest rate with investments that can mature in as
              little as three months or as long as a few years. With
              shorter-duration investments, you can redeploy your capital in a
          ...
          <span className="flex flex-col bg-[white] w-fit max-w-[35rem] min-h-fit max-h-80 pb-9 pt-9  p-7 rounded-xl  ">
            ...
            <p className="mt-2 text-[1rem] font-sans font-normal">
              Specify your desired yield and minimum investment amount during
              syndication. Onlyinvest if your parameters are met. For direct
          ...
          <span className="flex flex-col bg-[white] w-fit max-w-[35rem] min-h-fit max-h-80 pb-9 pt-9  p-7 rounded-xl  ">
            ...
            <p className="mt-2 text-[1rem] font-sans font-normal">
              Diversification by design. Blended Notes to quickly achieve broad
              diversification.
            </p>
          </span>
          <span className="flex flex-col bg-[white] w-fit max-w-[35rem] min-h-fit max-h-80 pb-9 pt-9  p-7 rounded-xl ">
            ...
            <p className="mt-2 text-[1rem] font-sans font-normal">
              With our proprietary technology, see and compare available deals
