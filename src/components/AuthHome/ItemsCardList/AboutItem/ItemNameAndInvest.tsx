  ...
  return (
    <>
      <div className="w-full flex h-16 bg-[#171718] items-center" ref={viewRef}>
        ...
        <span className="w-fit max-h-10 h-fit flex  bg-[#3a3ac5] hover:bg-[#0e0e77] hover:transition-all p-2 font-semibold text-gray-100 rounded-full ml-auto mr-5 mt-1 lg:mt-0 overflow-hidden pointer">
          <i className="fas fa-circle-check mr-0.5 mt-0.5 text-[1.2rem] font-normal"></i>
          <h5 className="hidden sm:block ">INVEST IN THIS DEAL</h5>
          <h5 className="sm:hidden block text-[16px]">INVEST </h5>
        </span>
      </div>
    </>
  );
