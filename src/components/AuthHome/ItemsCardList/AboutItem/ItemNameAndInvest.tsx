  ...
  return (
    <>
      <div className="w-full flex h-16 bg-[#171718] items-center" ref={viewRef}>
        ...
        <span className="w-fit h-fit flex  bg-[#3a3ac5] hover:bg-[#0e0e77] hover:transition-all p-2 font-semibold text-gray-100 rounded-full ml-auto mr-5 mt-1 lg:mt-0 overflow-hidden">
